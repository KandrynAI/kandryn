...
export const metadata: Metadata = {
  ...
  description:
    'Security controls, data handling, compliance status, and sub-processor list for Kandryn enterprise customers.',
...
const TRUST_ROWS: TrustRow[] = [
  ...
  { tone: 'green', control: 'Security scanning', status: 'Aegis scans committed code for OWASP Top 10 on request (fail-closed) and posts a status check to the pull request on GitHub and Azure Repos. It blocks a merge once you require that check in a branch rule or policy.', anchor: '#ai-and-models', link: 'AI and models' },
        ...
        <div className="grid-3 stack-1" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 24, marginTop: 36 }}>
          {[
            ...
            },
            {
              ...
              b: 'Every API call is made using the customer’s own Anthropic and OpenAI API keys, stored per-user and never shared. You see the usage in your own Anthropic/OpenAI dashboards. Kandryn does not proxy or aggregate model costs.',
            },
            {
