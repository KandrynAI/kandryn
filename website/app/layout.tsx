...
const DESC =
  'An AI delivery assistant that reads a work item, runs two models against it, ranks the answers, and opens the pull request. Run it now, or queue tonight and read the diffs in the morning.';
