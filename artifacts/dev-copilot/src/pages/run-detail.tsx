      ...
      {isCommitted && committedSug && committedSug.scoreBreakdown && (
        <div style={{ padding: "0 20px 8px", maxWidth: 760 }}>
          <ExplanationSection
            ...
            approvedBy={run.approvedByUserId}
...
function ExplanationSection({
  ...
  return (
    <div style={{ animation: "bmrise 0.3s ease-out both" }}>
      ...
      {committed.model && (
        <div style={{ marginTop: 8, fontSize: "var(--fs-sm)", color: "var(--c-ink-3)", lineHeight: 1.45 }}>
          <span style={{ color: "var(--c-ink)", fontWeight: 600 }}>Generated by: </span>
          <span style={{ fontFamily: "var(--mono)" }}>{committed.model}</span>
        </div>
      )}

      {approvedBy && (
        <div style={{ marginTop: 8, fontSize: "var(--fs-sm)", color: "var(--c-ink-3)", lineHeight: 1.45 }}>
          <span style={{ color: "var(--c-ink)", fontWeight: 600 }}>Human approval: </span>
          this plan was gated for review and approved by <span style={{ fontFamily: "var(--mono)" }}>{approvedBy}</span>
